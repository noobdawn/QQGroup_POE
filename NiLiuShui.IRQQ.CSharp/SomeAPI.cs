...
namespace NiLiuShui.IRQQ.CSharp
{
    class SomeAPI : IModule
    {
        ...
        const string QQ_MUSIC_JSON_F = "{\"app\":\"com.tencent.music\",\"desc\":\"音乐\",\"view\":\"RichInfomation\",\"ver\":\"0.0.0.1\",\"prompt\":\"[应用]音乐\",\"meta\":{\"Music.Get\":{\"Music.Name\":\"";
        const string QQ_MUSIC_JSON_B = "\"}},\"config\":{\"type\":\"card\",\"forward\":1,\"autosize\":1}}";
